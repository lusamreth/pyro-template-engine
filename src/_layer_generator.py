...
from analyzer._scope_analyzer_prune import analyzeScope
# from analyzer.scope_analyzer import analyzeScope
                ...
                if isScopedConfig:
                    ...
                    if ptrInfo.get("prev"):
                        ...
                        for i, chl in enumerate(childAncestors[1 : l - 1]):
                            ...
                            print(
                                "clone", chl, childAncestors, child.get("level"), result
                            )
